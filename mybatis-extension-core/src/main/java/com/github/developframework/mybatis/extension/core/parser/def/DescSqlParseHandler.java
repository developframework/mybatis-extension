 ...
 */
public class DescSqlParseHandler implements MapperMethodParseHandler {
    ...
    public MapperMethodParseWrapper handle(Configuration configuration, EntityDefinition entityDefinition, SqlSourceBuilder sqlSourceBuilder, Method method) {
        final SqlSource sqlSource = sqlSourceBuilder.buildDescSql(configuration, entityDefinition);
