 ...
 */
public class SelectByIdLockSqlParseHandler extends AbstractSqlParseHandler {
    ...
    public MapperMethodParseWrapper handle(Configuration configuration, EntityDefinition entityDefinition, SqlSourceBuilder sqlSourceBuilder, Method method) {
        final SqlSource sqlSource = sqlSourceBuilder.buildSelectByIdSql(configuration, entityDefinition, method, true);
