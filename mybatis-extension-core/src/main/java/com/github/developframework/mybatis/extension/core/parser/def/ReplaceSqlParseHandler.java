 ...
 */
public class ReplaceSqlParseHandler implements MapperMethodParseHandler {
    ...
    public MapperMethodParseWrapper handle(Configuration configuration, EntityDefinition entityDefinition, SqlSourceBuilder sqlSourceBuilder, Method method) {
        final SqlSource sqlSource = sqlSourceBuilder.buildReplaceSql(configuration, entityDefinition, method);
